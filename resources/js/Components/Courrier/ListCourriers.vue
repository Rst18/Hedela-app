<template>
    ...
    <div v-else>
        ...
        <div v-else class="w-full mt-5 p-4 grid place-items-center text-gray-600">
            ...
            <p class="text-center mt-4 bg-blue-500  bg-green-300 bg-teal-500 bg-orange-400 bg-red-500 bg-green-300">Pas de données a afficher pour le moment, veuillez creer au moins un document !  </p>
        </div>
        </form>
    </div>
</template>
