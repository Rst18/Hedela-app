<template>
    ...
    <div class="relative grid grid-cols-12 gap-4 ">
        <div class="col-span-3 grid grid-cols-1  gap-4 p-4 rounded-r-2xl   border shadow-md h scroll overflow-auto">
            <OptionsComponent @showAidesMemoire="chooseAideMemoire"  :reunion :is_Admin />
        </div>
        <div class="col-span-7 border  rounded-2xl  p-8 shadow-md  h scroll overflow-auto">
           
             <AidesMemoireList :aides_memoire="reunion.aides_memoire" v-if="addAideMemoireAdmin"  @closeMe="addAideMemoireAdmin = false"/>
            <div>
...
<script setup>
    ...
    import AlertNotification from '@/Components/AlertNotification.vue'
        ...
        const chooseAideMemoire = ()=> props.is_Admin === 1 ?    addAideMemoireAdmin.value = true :  addAideMemoireUser.value = true
