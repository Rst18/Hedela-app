...
<div class="bg-gray-100">
    <div class="max-w-screen-lg py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
        ...
        <div class="p-5 sm:w-7/12 border-r text-center">
            <h3 class="font-bold text-xl text-indigo-600 mb-4">Hedela-app,</h3>
            <p class="text-gray-500 text-sm mb-10"> Optimise vos processus de traitement de courrier et vous fait gagnez en temps et en productivité. la solution complète de gestion des courriers.</p>
        </div>
        <div class="p-5 sm:w-3/12">
            <div class="text-sm uppercase text-indigo-600 font-bold">Contact Us</div>
            <ul>
                <li class="my-2">
                    <a class="hover:text-indigo-600" href="#">+243 975 476 177 </a>
                </li>
                <li class="my-2">
                    <!-- <a class="hover:text-indigo-600" href="#">Avenue Kalemie N°43 Kinshasa Gombe RDC</a> -->
                </li>
                <li class="my-2">
                    <a class="hover:text-indigo-600" href="#">Hedela</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="flex py-5 m-auto text-gray-800 text-sm flex-col items-center border-t max-w-screen-xl">
        ...
        <div class="my-5">© Copyright {{ date.getFullYear() }}. Hedela-app All Rights Reserved.</div>
    </div>
</div>
</template>
<script setup>
