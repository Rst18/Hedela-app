<template>
    <nav
        class="bg-white shadow border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50"
    >
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex items-center lg:order-2">
                ...
                >
                    ...
                    <span class="sr-only">{{  $page.props.auth.unreadNotification  }} Rosand</span>
                    <!-- Bell icon -->
                    <svg
                        aria-hidden="true"
                        class="w-6 h-6"
                    ...
                    <span class="absolute top-1 right-1 font-bold text-xs text-red-600">{{  $page.props.auth.unreadNotification  }}</span>
                ...
                >
                    ...
                    <div v-for=" note in $page.props.auth.user.notifications">
                        <a
                            href="#"
                ...
                >
                    ...
                    >
                        <li>
                            <NavLink :href="route('profile.edit')" :active="route().current('profile.edit')" class="block py-2 w-full px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">
                                Profile
                            </NavLink>
                    ...
                    >
                        <li>
                            <NavLink :href="route('logout')" method="post" as="button" class="block py-2 w-full px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">
                                Déconnexion
                            </NavLink>
